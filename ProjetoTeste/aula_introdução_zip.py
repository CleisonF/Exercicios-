...
CAMINHO_ZIP_DIR = CAMINHO_RAIZ / 'aula_introdução_zip_diretorio_zip'
CAMINHO_COMPACTADO = CAMINHO_RAIZ / 'aula_introdução_zip_compactado.zip'
CAMINHO_DESCOMPACTADO = CAMINHO_RAIZ / 'aula_introdução_zip_descompactado'
...
#ler o arquivo zipado
with ZipFile(CAMINHO_COMPACTADO,'r') as zip:
    for arquivo in zip.namelist():
        print(arquivo)

#para descompactar o arquivo zipado
with ZipFile(CAMINHO_COMPACTADO, 'r') as zip:
